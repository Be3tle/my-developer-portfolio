      ...
      <div className="hero-content flex-col lg:flex-row-reverse  gap-20 lg:gap-56">
        ...
        <div className="max-w-2xl">
          ...
          <p className="py-9 text-neutral-300 text-justify">
            Frontend focused MERN stack enthusiast on a mission to level up from
            coding to leadership. I specialize in building web applications and
            am determined to become a tech lead. Passionate about turning
